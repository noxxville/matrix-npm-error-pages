...
```bash
git clone <DEIN_REPO> matrix-nginx-error-pages
cd matrix-nginx-error-pages
code .
```

Dann z. B. `error_pages/matrix_404.html` mit einem Live-Server-Plugin öffnen
und das Verhalten lokal testen.
